...
<template>
  ...
  >
    <p v-if="title" class="bg-gradient-to-r from-zinc-500/30 text-xs text-zinc-100 tracking-wider h-7 flex items-center px-2 text-shadow-xl" v-html="title"></p>
    <div class="w-full h-[calc(100%-1.75rem)] flex relative">
      <slot></slot>
    </div>
  </div>
</template>