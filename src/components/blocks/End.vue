      ...
      <div class="text-zinc-300 flex flex-1 my-4">
        ...
        <div v-else-if="props.state?.title === '最后幸存'" class="m-auto">
          ...
          <div v-if="nowPage == 1">
            ...
            <br>
            <img src="/old/img/story/story_ne2.png" class="m-auto">
            <br>
          ...
          <div v-if="nowPage == 4">
            ...
            <br>
            <img src="/old/img/story/story_ne3.png" class="m-auto"><br>
            <br>
        ...
        <div v-else-if="props.state?.title === '核爆全灭'" class="m-auto">
          ...
          <template v-if="props.state?.flag.state === 6">
            <div v-if="nowPage == 0">
              ...
              <img src="/old/img/story/story_ne4.gif" class="m-auto">
            </div>
            <div v-if="nowPage == 1">
        ...
        <div v-else-if="props.state?.title === '幻境解离'" class="m-auto">
          ...
          <template v-if="props.state?.flag.state == 6">
            ...
            <div v-if="nowPage == 6">
              ...
              <br>
              <img src="/old/img/story/story_ne1.jpg" class="m-auto"><br>
            </div>
            <div v-if="nowPage == 7">
